...
func (mr *MockEnvMockRecorder) GetRadixConfigBranch() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRadixConfigBranch", reflect.TypeOf((*MockEnv)(nil).GetRadixConfigBranch))
}
...
func (m *MockEnv) GetSourceDeploymentGitBranch() string {
	m.ctrl.T.Helper()
...
func (mr *MockEnvMockRecorder) GetSourceDeploymentGitBranch() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSourceDeploymentGitBranch", reflect.TypeOf((*MockEnv)(nil).GetSourceDeploymentGitBranch))
}

// GetSourceDeploymentGitCommitHash mocks base method.
func (m *MockEnv) GetSourceDeploymentGitCommitHash() string {
	m.ctrl.T.Helper()
...
func (mr *MockEnvMockRecorder) GetSourceDeploymentGitCommitHash() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSourceDeploymentGitCommitHash", reflect.TypeOf((*MockEnv)(nil).GetSourceDeploymentGitCommitHash))
}
